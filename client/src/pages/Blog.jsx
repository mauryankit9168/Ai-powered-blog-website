      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        {}
         <div className='mt-14 mb-10 max-w-3xl mx-auto'>
           <p className='font-semihold mb-4'>Comments ({comments.length})</p>
           <div className='flex flex-col gap-4'>
            ...
            <div className='max-w-3xl mx-auto'>
              ...
              <form action="" onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
                ...
                <textarea onChange={(e)=>setContent(e.target.value)} value={content} name="" id="" placeholder='Comment' className='w-full p-2 border border-gray-300 rounded outline-none h-48'></textarea>
